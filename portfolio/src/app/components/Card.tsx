...
const Card = (props: Props) => {
  return (
    <div className='group relative h-72 overflow-hidden rounded-xl bg-neutral-300 text-dark  shadow-lg dark:brightness-125 transition-transform duration-300 hover:scale-95 dark:bg-neutral-800 dark:text-light '>
      ...
      <div className='absolute inset-0 hidden flex-wrap items-center justify-center gap-x-3 bg-opacity-75 text-light backdrop-blur-md group-hover:flex dark:text-light'>
